...
describe('registerCertificate', () => {
  test('should throw error when some properties are not provied', async () => {
    const clientServiceBase = new ClientServiceBase(
      {} as ScalarService & {signerFactory: SignatureSignerFactory}, // service
      {} as ScalarMessage, // protobuf
      {}, // properties
...
describe('executeContract', () => {
  test('should throw error when some properties are not provied', async () => {
    ...
    await expect(clientServiceBase.execute('id', {})).rejects.toThrowError();
  });
